...
@Component({
    ...
    @Input('array') private array: Array<any>;
    ...
    @Input('carousel_id') private carousel_id:string = 'carousel';
    @Input('url') private url: string;
    @Input('id') private id: string;
    @Input('color') private color: string;
    @Input('url_static') private url_static: boolean = false;
    ...
    getTitleInfo(entry){
        let a = this.base !== null? entry[this.base][this.title_info] : "";
        let b = this.base !== null? entry[this.base][this.title_info_2]?entry[this.base][this.title_info_2]: "" : "";
        let c = entry[this.title_info];
        let d = entry[this.title_info_2]?entry[this.title_info_2]: "";
